...
func (s *service) Ctor(
	config *contracts_cookies.WellknownCookieNamesConfig,
) (contracts_cookies.IWellknownCookieNames, error) {
	...
	cookieNames := map[contracts_cookies.CookieName]string{
		...
		contracts_cookies.CookieName_SkipKeepSignedIn:            prefix + "_skipKeepSignedIn",
...
func AddSingletonIWellknownCookieNames(cb di.ContainerBuilder, config *contracts_cookies.WellknownCookieNamesConfig) {
	di.AddSingleton[contracts_cookies.IWellknownCookieNames](cb, stemService.Ctor)
	di.AddInstance[*contracts_cookies.WellknownCookieNamesConfig](cb, config)
}
