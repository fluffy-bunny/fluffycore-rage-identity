...
import (
	...
	services_identitycreationprotection "github.com/fluffy-bunny/fluffycore-rage-identity/pkg/services/identitycreationprotection"
...
func ConfigureServices(ctx context.Context, config *contracts_config.Config, builder di.ContainerBuilder) error {
	...
	services_identitycreationprotection.AddSingletonIIdentityCreationProtection(builder)
