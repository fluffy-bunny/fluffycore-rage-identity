...
import (
	...
	services_oidcuser_inmemory "github.com/fluffy-bunny/fluffycore-rage-identity/cmd/server/internal/services/oidcuser/inmemory"
	services_user_id_generator "github.com/fluffy-bunny/fluffycore-rage-identity/cmd/server/internal/services/oidcuser/user_id_generator"
	services_users_inmemory "github.com/fluffy-bunny/fluffycore-rage-identity/cmd/server/internal/services/users/inmemory"
...
func MyConfigServices(ctx context.Context, builder di.ContainerBuilder) {
	...
	services_users_inmemory.AddSingletonIFluffyCoreUserServiceServer(builder)
}
