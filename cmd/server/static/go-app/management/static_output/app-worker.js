...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "1767558035";
const resourcesToCache = ["web/webauthn.js?v=1767558035","web/styles.css?v=1767558035","web/m_logo.svg?v=1767558035","web/logging-helper.js?v=1767558035","web/common.js?v=1767558035","web/build_version.js?v=1767558035","web/app.wasm?v=1767558035","wasm_exec.js?v=1767558035","manifest.webmanifest?v=1767558035","app.js?v=1767558035","app.css?v=1767558035"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker 1767558035");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker 1767558035 is activated");
  } catch (error) {
