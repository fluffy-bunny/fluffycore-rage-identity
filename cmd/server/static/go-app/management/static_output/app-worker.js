...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "1766088744";
const resourcesToCache = ["web/webauthn.js?v=1766088744","web/styles.css?v=1766088744","web/m_logo.svg?v=1766088744","web/logging-helper.js?v=1766088744","web/common.js?v=1766088744","web/build_version.js?v=1766088744","web/app.wasm?v=1766088744","wasm_exec.js?v=1766088744","manifest.webmanifest?v=1766088744","app.js?v=1766088744","app.css?v=1766088744"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker 1766088744");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker 1766088744 is activated");
  } catch (error) {
