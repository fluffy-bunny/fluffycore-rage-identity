...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/management/","GOAPP_STATIC_RESOURCES_URL":"/management/web","GOAPP_VERSION":"1766088744"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("web/app.wasm?v=1766088744", showProgress),
      go.importObject
    );
