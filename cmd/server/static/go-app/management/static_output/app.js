...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/management/","GOAPP_STATIC_RESOURCES_URL":"/management/web","GOAPP_VERSION":"1765728231"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("web/app.wasm?v=1765728231", showProgress),
      go.importObject
    );
