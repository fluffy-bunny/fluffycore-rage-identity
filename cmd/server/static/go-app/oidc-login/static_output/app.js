...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/oidc-login/","GOAPP_STATIC_RESOURCES_URL":"/oidc-login/web","GOAPP_VERSION":"1765998683"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("web/app.wasm?v=1765998683", showProgress),
      go.importObject
    );
