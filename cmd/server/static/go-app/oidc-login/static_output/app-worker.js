...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "1766177744";
const resourcesToCache = ["web/webauthn.js?v=1766177744","web/styles.css?v=1766177744","web/m_logo.svg?v=1766177744","web/logging-helper.js?v=1766177744","web/common.js?v=1766177744","web/build_version.js?v=1766177744","web/app.wasm?v=1766177744","wasm_exec.js?v=1766177744","manifest.webmanifest?v=1766177744","app.js?v=1766177744","app.css?v=1766177744"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker 1766177744");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker 1766177744 is activated");
  } catch (error) {
