...
//
// Vendored from: https://github.com/cloudevents/spec/blob/main/cloudevents/formats/cloudevents.proto

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.36.10
// 	protoc        v4.25.1
// source: proto/events/types/cloudevents.proto
...
type CloudEvent struct {
	...
	// Data (bytes, text, or protobuf message)
	//
...
func (x *CloudEvent) Reset() {
	*x = CloudEvent{}
	mi := &file_proto_events_types_cloudevents_proto_msgTypes[0]
...
func (*CloudEvent) Descriptor() ([]byte, []int) {
	return file_proto_events_types_cloudevents_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudEventBatch) Reset() {
	*x = CloudEventBatch{}
	mi := &file_proto_events_types_cloudevents_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudEventBatch) Descriptor() ([]byte, []int) {
	return file_proto_events_types_cloudevents_proto_rawDescGZIP(), []int{1}
}
...
func (x *CloudEvent_CloudEventAttributeValue) Reset() {
	*x = CloudEvent_CloudEventAttributeValue{}
	mi := &file_proto_events_types_cloudevents_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CloudEvent_CloudEventAttributeValue) Descriptor() ([]byte, []int) {
	return file_proto_events_types_cloudevents_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_proto_events_types_cloudevents_proto protoreflect.FileDescriptor

const file_proto_events_types_cloudevents_proto_rawDesc = "" +
	"\n" +
	"$proto/events/types/cloudevents.proto\x12\vproto.types\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc3\x05\n" +
	"\n" +
	"CloudEvent\x12\x0e\n" +
	...
	"\n" +
	"attributes\x18\x05 \x03(\v2'.proto.types.CloudEvent.AttributesEntryR\n" +
	"attributes\x12!\n" +
	"\vbinary_data\x18\x06 \x01(\fH\x00R\n" +
	"binaryData\x12\x1d\n" +
	"\ttext_data\x18\a \x01(\tH\x00R\btextData\x125\n" +
	"\n" +
	"proto_data\x18\b \x01(\v2\x14.google.protobuf.AnyH\x00R\tprotoData\x1ao\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12F\n" +
	"\x05value\x18\x02 \x01(\v20.proto.types.CloudEvent.CloudEventAttributeValueR\x05value:\x028\x01\x1a\x9a\x02\n" +
	...
	"\x06events\x18\x01 \x03(\v2\x17.proto.types.CloudEventR\x06eventsB\x98\x01\n" +
	"%com.fluffybunny.rageoidc.events.typesP\x01ZIgithub.com/fluffy-bunny/fluffycore-rage-identity/proto/events/types;types\xaa\x02!FluffyBunny.RageOidc.Events.Typesb\x06proto3"

var (
	file_proto_events_types_cloudevents_proto_rawDescOnce sync.Once
	file_proto_events_types_cloudevents_proto_rawDescData []byte
)

func file_proto_events_types_cloudevents_proto_rawDescGZIP() []byte {
	file_proto_events_types_cloudevents_proto_rawDescOnce.Do(func() {
		file_proto_events_types_cloudevents_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_events_types_cloudevents_proto_rawDesc), len(file_proto_events_types_cloudevents_proto_rawDesc)))
	})
	return file_proto_events_types_cloudevents_proto_rawDescData
}

var file_proto_events_types_cloudevents_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_events_types_cloudevents_proto_goTypes = []any{
	(*CloudEvent)(nil),      // 0: proto.types.CloudEvent
	(*CloudEventBatch)(nil), // 1: proto.types.CloudEventBatch
	nil,                     // 2: proto.types.CloudEvent.AttributesEntry
	(*CloudEvent_CloudEventAttributeValue)(nil), // 3: proto.types.CloudEvent.CloudEventAttributeValue
	(*anypb.Any)(nil),             // 4: google.protobuf.Any
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
}
var file_proto_events_types_cloudevents_proto_depIdxs = []int32{
	2, // 0: proto.types.CloudEvent.attributes:type_name -> proto.types.CloudEvent.AttributesEntry
	4, // 1: proto.types.CloudEvent.proto_data:type_name -> google.protobuf.Any
	0, // 2: proto.types.CloudEventBatch.events:type_name -> proto.types.CloudEvent
	3, // 3: proto.types.CloudEvent.AttributesEntry.value:type_name -> proto.types.CloudEvent.CloudEventAttributeValue
	5, // 4: proto.types.CloudEvent.CloudEventAttributeValue.ce_timestamp:type_name -> google.protobuf.Timestamp
...
func init() { file_proto_events_types_cloudevents_proto_init() }
func file_proto_events_types_cloudevents_proto_init() {
	if File_proto_events_types_cloudevents_proto != nil {
		return
	}
	file_proto_events_types_cloudevents_proto_msgTypes[0].OneofWrappers = []any{
		(*CloudEvent_BinaryData)(nil),
		(*CloudEvent_TextData)(nil),
		(*CloudEvent_ProtoData)(nil),
	}
	file_proto_events_types_cloudevents_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_events_types_cloudevents_proto_rawDesc), len(file_proto_events_types_cloudevents_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_events_types_cloudevents_proto_goTypes,
		DependencyIndexes: file_proto_events_types_cloudevents_proto_depIdxs,
		MessageInfos:      file_proto_events_types_cloudevents_proto_msgTypes,
	}.Build()
	File_proto_events_types_cloudevents_proto = out.File
	file_proto_events_types_cloudevents_proto_goTypes = nil
	file_proto_events_types_cloudevents_proto_depIdxs = nil
}
