...
var file_proto_oidc_models_client_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x73, 0x42, 0x90, 0x01, 0x0a, 0x20, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x75, 0x66,
	0x66, 0x79, 0x62, 0x75, 0x6e, 0x6e, 0x79, 0x2e, 0x68, 0x61, 0x6e, 0x6b, 0x6f, 0x6f, 0x69, 0x64,
	0x63, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x50, 0x01, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68,
	...
	0x6c, 0x73, 0xaa, 0x02, 0x21, 0x46, 0x6c, 0x75, 0x66, 0x66, 0x79, 0x42, 0x75, 0x6e, 0x6e, 0x79,
	0x2e, 0x48, 0x61, 0x6e, 0x6b, 0x6f, 0x4f, 0x69, 0x64, 0x63, 0x2e, 0x4f, 0x69, 0x64, 0x63, 0x2e,
...
var file_proto_oidc_models_client_proto_goTypes = []interface{}{
...
func file_proto_oidc_models_client_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_oidc_models_client_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Claim); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_oidc_models_client_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Client); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_oidc_models_client_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_oidc_models_client_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_oidc_models_client_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_proto_oidc_models_client_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*ClaimsUpdate_Granular_)(nil),
		(*ClaimsUpdate_Replace)(nil),
	}
	file_proto_oidc_models_client_proto_msgTypes[5].OneofWrappers = []interface{}{
