...
func request_IDPService_GetIDPBySlug_0(ctx context.Context, marshaler runtime.Marshaler, client IDPServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetIDPBySlugRequest
	var metadata runtime.ServerMetadata
...
func RegisterIDPServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server IDPServiceServer) error {
	...
	mux.Handle("GET", pattern_IDPService_GetIDPBySlug_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("POST", pattern_IDPService_UpdateIDP_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("POST", pattern_IDPService_ListIDP_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
