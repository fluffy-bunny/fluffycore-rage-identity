...
func (c *clientServiceClient) ListClient(ctx context.Context, in *ListClientRequest, opts ...grpc.CallOption) (*ListClientResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClientService_ListClient_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientServiceClient) AddNewClientSecret(ctx context.Context, in *AddNewClientSecretRequest, opts ...grpc.CallOption) (*AddNewClientSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClientService_AddNewClientSecret_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientServiceClient) ValidateClientSecret(ctx context.Context, in *ValidateClientSecretRequest, opts ...grpc.CallOption) (*ValidateClientSecretResponse, error) {
	...
	err := c.cc.Invoke(ctx, ClientService_ValidateClientSecret_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
