...
func (c *rageUserServiceClient) CreateRageUser(ctx context.Context, in *CreateRageUserRequest, opts ...grpc.CallOption) (*CreateRageUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, RageUserService_CreateRageUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rageUserServiceClient) GetRageUser(ctx context.Context, in *GetRageUserRequest, opts ...grpc.CallOption) (*GetRageUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, RageUserService_GetRageUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rageUserServiceClient) UpdateRageUser(ctx context.Context, in *UpdateRageUserRequest, opts ...grpc.CallOption) (*UpdateRageUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, RageUserService_UpdateRageUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rageUserServiceClient) LinkRageUser(ctx context.Context, in *LinkRageUserRequest, opts ...grpc.CallOption) (*LinkRageUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, RageUserService_LinkRageUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rageUserServiceClient) UnlinkRageUser(ctx context.Context, in *UnlinkRageUserRequest, opts ...grpc.CallOption) (*UnlinkRageUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, RageUserService_UnlinkRageUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRageUserServiceServer must be embedded to have
...
func (UnimplementedRageUserServiceServer) testEmbeddedByValue()                         {}
...
func RegisterRageUserServiceServer(s grpc.ServiceRegistrar, srv RageUserServiceServer) {
	// If the following call pancis, it indicates UnimplementedRageUserServiceServer was
