...
func main() {
	...
	// gen_images is at: example/go-app/management/cmd/gen_images
	// SVG source is at: example/go-app/management/web/m_logo.svg
	// Output should go to: example/go-app/management/web/
